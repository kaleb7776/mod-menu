--[[
    RAVION UI - Compkiller Red Edition
    Author: 4lpaca (modificado por RAVION)
    License: MIT
    ...
    - Nome da janela "RAVION UI"
    - Aprimoramentos de segurança (getui, cloneref, protect_gui)
    - Cache de imagens ativado por padrão
--]]
...
-- TEMA VERMELHO PERSONALIZADO (cores principais)
Compkiller.Colors = {
    Highlight = Color3.fromRGB(255, 50, 50),    -- vermelho brilhante
    Toggle = Color3.fromRGB(200, 30, 30),       -- vermelho escuro
    Risky = Color3.fromRGB(255, 150, 50),       -- laranja para risco
    BGDBColor = Color3.fromRGB(18, 18, 22),     -- fundo escuro
    ...
    MouseEnter = Color3.fromRGB(70, 30, 30),
    BlockBackground = Color3.fromRGB(39, 40, 47),
    LineColor = Color3.fromRGB(65, 65, 65),
    HighStrokeColor = Color3.fromRGB(80, 40, 40),
};
...
function Compkiller.new(Config : Window)
    ...
    Config = Compkiller.__CONFIG(Config , {
        Name = "RAVION UI", -- Nome modificado
        Keybind = "Insert",
...
-- Ativa modo de segurança por padrão para maior proteção (cache de imagens e blur)
Compkiller:Security("RAVION-Cache", { BlurEnabled = true, ImageScale = 150 })
